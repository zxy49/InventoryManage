...
@WebServlet("/getstoreitems_itemid")
public class GetStoreItemsServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (content != "") {
			...
			try {
				...
				String itemid=object.getString("commodity_id");
				WorkerDaoImpl wo = new WorkerDaoImpl();
				
				ArrayList<StoreItemList> items=wo.getStoreItems(itemid);
